...
int main( void ){
   ...
   schedulerAddTask( myButtonUpdate, // funcion de tarea a agregar
                     TEC1,  // parametro de la tarea
                     0,            // offset de ejecucion en ticks
                     40           // periodicidad de ejecucion en ticks
                   );

   schedulerAddTask( myBlinkerUpdate, // funcion de tarea a agregar
                        LED2,  // parametro de la tarea
                        10,            // offset de ejecucion en ticks
                        20           // periodicidad de ejecucion en ticks
                      );
